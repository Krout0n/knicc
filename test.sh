...
exit_code 'typedef struct { int x;} Point; int main() { Point p; p.x = 1;}' '1'
exit_code 'typedef struct { int x; int y; } Point; int main() { Point p; p.x = 1;}' '1'
exit_code 'typedef struct { int x; int y; } Point; int main() { Point p; p.y = 2;}' '2'
exit_code 'typedef struct { int x; int y; } Point; int main() { Point p; p.x = 1; p.y = 2; return p.x + p.y; }' '3'
exit_code 'typedef struct { int x; int y; } Point; int main() { Point p; p.x = 1; p.y = 2; return p.x + 1; }' '2'
exit_code 'typedef struct { int x; int y; } Point; int main() { Point p; p.x = 1; p.y = 2; Point q; q.x = 3; q.y = 4; return p.x + q.y; }' '5'
