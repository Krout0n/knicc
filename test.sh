...
# exit_code 'int main() { 3 * 2; }' '6'
# exit_code 'int main() { return 3 * 2; }' '6'
exit_code 'int i; int main() { i = 10; return i;}' '10'
exit_code 'int a[5]; int main() { a[2] = 10; return a[2];}' '10'
exit_code 'int a[5]; int main() { for (int i = 0; i < 5; i++) { a[i] = i; } return a[3];}' '3'
